...
def HTML_table_creator(file_1, file_2):
    ...
    table="<table class='table-fill'><tr><td class='text-left'>Długość r</td><td class='text-left'>Wynik</td></tr>\n"
...
HTML_table("Input/promien.txt","Output/promien.txt","HTML/adasd.html")